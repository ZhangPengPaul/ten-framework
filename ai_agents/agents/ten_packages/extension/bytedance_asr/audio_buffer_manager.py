...
class AudioBufferManager:
    """
    Manages audio data buffering for Bytedance ASR with fixed threshold.

    Features:
    - Fixed threshold (default: 1280 bytes for 10ms at 16kHz)
    ...
    def __init__(
        self,
        threshold_bytes: int = 1280,  # 1280 bytes for 10ms at 16kHz
        logger=None,
    ):
